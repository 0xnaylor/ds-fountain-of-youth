...
export default function update({ selected, world }) {
    ...
    const craft = () => {
        ...
        // Printed to the console when the building is used
        ds.log('Drinking from the fountain of youth');
    };
        ...
        components: [
            {
                ...
                //  building identifier
                id: 'elixir-of-life',
                // title will be displaye3d in-game
                title: 'Fountain of Youth',
                // This is the description text that displays on the building.
                summary: `I'll take four servings of the meanest, greenest goo you've got.`,
                content: [
                    {
                        id: 'default',
                        type: 'inline',
                        // This displays the button to “use” the building.
                        buttons: [
                            { text: 'Create Elixir', type: 'action', action: craft, disabled: !canCraft },
                        ],
                    },
                ],
            },
